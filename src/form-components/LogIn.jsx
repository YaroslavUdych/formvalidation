	...
	return (
		<div className="form-wrapper">
			...
			<div className="form-item-wrapper" ref={LogInElement}>
				...
				<div className="login-text__or">
					<span>Or</span>
				</div>
				<div className="login-social">
					<Button variant="outlined" size="small" startIcon={<GoogleIcon />} fullWidth>
						Sign in with Google
					</Button>
					<Button variant="outlined" size="small" startIcon={<FacebookIcon />} fullWidth>
